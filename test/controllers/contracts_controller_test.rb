...
class ContractsControllerTest < ActionController::TestCase
  ...
  test "should update contract" do
    patch :update, id: @contract, contract: { company: @contract.company, description: @contract.description, image_url: @contract.image_url, pay: @contract.pay, title: @contract.title }
    assert_redirected_to contract_path(assigns(:contract))
  end
